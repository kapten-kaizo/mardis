...
try:
    ...
    exit(str(i))
script_name = 'mardis'
rg = ajg('')
im_kaizo = ajg('IyBEZWNvbXBpbGUgYnkgS2FuZ0VoZW06KQojIFRpbWUgU3VjY2VzIGRlY29tcGlsZSA6ICVzCiVzCiMgTWF1IE5nYXBhaW4gQ3VrPw==')
def rmbg(file_name):
    console = []
